...
import {stepThreeSchemaDashboard} from '../reusables/validationSchema.jsx';
...
export function BioForm3() {
	...
	const {
		...
		resolver: yupResolver(stepThreeSchemaDashboard),
		mode: "onChange",
	});
	...
	return (
		<form className='step-three-dashboard'
