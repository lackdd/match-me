...
import {stepTwoSchemaDashboard} from '../reusables/validationSchema.jsx';
...
export function BioForm2() {
	...
	const {
		...
		resolver: yupResolver(stepTwoSchemaDashboard),
		mode: "onBlur",
	});

	return (

		<form className='step-two-dashboard'
